                            ...
                            <Col key={ingreso.id_ingreso}>
                                <Accordion.Item eventKey={ingreso.id_ingreso}>
                                    <Accordion.Header>
                                        ...
                                        <Col className="acordion-title-number" xs={3} md={3}><b>${formatNumber(ingreso.valor_cobro)}</b> </Col>
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        <Row>
                                            <Col xs={12} md={6}>Fecha del cobro<b>:</b> {ingreso.fecha_cobro}</Col>
                                            {(ingreso.fecha_diferido_cobro != ingreso.fecha_cobro) && <>
                                                <Col xs={12} md={6}>Fecha diferida<b>:</b> {ingreso.fecha_diferido_cobro}</Col>
                                            </>}
                                        </Row>
                                        <Row>
